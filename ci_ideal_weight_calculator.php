...
Version: 1.0.0
Author: Ideal Weight Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Ideal Weight Calculator by www.calculator.io";

function display_calcio_ci_ideal_weight_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_ideal_weight_calculator', 'display_calcio_ci_ideal_weight_calculator' );